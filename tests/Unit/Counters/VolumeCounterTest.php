...
//            ],
//        ];
//        dump($expected[STR_AVERAGES]);
//        dump($this->counter->getRawData()[STR_EVENTS]);
//
...
//        dump($expected[STR_VOLUMES], $this->counter->getVolumeArray()[STR_VOLUMES]);
        $this->assertEquals($expected, $this->counter->getVolumeArray());
        $expected = [
            STR_TOTAL => [
                P_01MIN => 3,
...
//    /** @test */
//    public function instanceComplexFillThree(): void
//    {
////        $data = new Rewindable(
////            [CommonTrades::class, 'generator'],
////            new Circular([T_ASK, T_BID,]),
////            new Circular(['ltc_btc']),
////            new Circular(
////                [0.00876,0.00867,0.00872,0.00878, ]
////            ),
////            new Circular([0.00100001, 0.00100001, 0.002, 0.002])
////        );
//
//        $this->counter = new VolumeCounter();
//        $this->counter->enableRelativeMode();
